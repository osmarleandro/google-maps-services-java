...
public class DistanceMatrixApiRequest_RENAMED
    extends PendingResultBase<DistanceMatrix, DistanceMatrixApiRequest_RENAMED, Response> {

  public DistanceMatrixApiRequest_RENAMED(GeoApiContext context) {
   ...
   */
  public DistanceMatrixApiRequest_RENAMED origins(String... origins) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED origins(LatLng... points) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED destinations(String... destinations) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED destinations(LatLng... points) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED mode(TravelMode mode) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED avoid(RouteRestriction restriction) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED units(Unit unit) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED departureTime(Instant departureTime) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED trafficModel(TrafficModel trafficModel) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED arrivalTime(Instant arrivalTime) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED transitModes(TransitMode... transitModes) {
   ...
   * @return Returns this {@code DistanceMatrixApiRequest} for call chaining.
   */
  public DistanceMatrixApiRequest_RENAMED transitRoutingPreference(TransitRoutingPreference pref) {
