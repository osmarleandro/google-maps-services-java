...
public abstract class RateLimiter {
  ...
  public <T> List<Future<T>> invokeAll(RateLimitExecutorService rateLimitExecutorService, Collection<? extends Callable<T>> callables)
      throws InterruptedException {
    return rateLimitExecutorService.delegate.invokeAll(callables);
  }
