...
public abstract class RateLimiter {
  ...
  public static RateLimiter create(double permitsPerSecond) {
     ...
     */
    return create_RENAMED(permitsPerSecond, SleepingStopwatch.createFromSystemTimer());
  }

  static RateLimiter create_RENAMED(double permitsPerSecond, SleepingStopwatch stopwatch) {
