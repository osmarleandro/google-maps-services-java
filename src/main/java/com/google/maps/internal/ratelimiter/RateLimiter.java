...
public abstract class RateLimiter {
  ...
  public <T> Future<T> submit(RateLimitExecutorService rateLimitExecutorService, Runnable runnable, T t) {
    return rateLimitExecutorService.delegate.submit(runnable, t);
  }
