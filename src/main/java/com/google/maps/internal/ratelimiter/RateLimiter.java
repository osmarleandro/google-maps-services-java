...
public abstract class RateLimiter implements IRateLimiter {
  ...
  static IRateLimiter create(double permitsPerSecond, SleepingStopwatch stopwatch) {
    IRateLimiter rateLimiter = new SmoothBursty(stopwatch, 1.0 /* maxBurstSeconds */);
   ...
   */
  public static IRateLimiter create(double permitsPerSecond, long warmupPeriod, TimeUnit unit) {
  ...
  static IRateLimiter create(
    ...
    IRateLimiter rateLimiter = new SmoothWarmingUp(stopwatch, warmupPeriod, unit, coldFactor);
    rateLimiter.setRate(permitsPerSecond);
    return rateLimiter;
  }
