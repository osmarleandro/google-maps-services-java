  ...
  private T parseResponseInternal(GaePendingResult<T, R> request, HTTPResponse response)
    ...
    Gson gson =
        new GsonBuilder()
            ...
            .registerTypeAdapter(
                AddressComponentType.class, new SafeEnumAdapter_RENAMED<>(AddressComponentType.UNKNOWN))
            .registerTypeAdapter(AddressType.class, new SafeEnumAdapter_RENAMED<>(AddressType.UNKNOWN))
            .registerTypeAdapter(TravelMode.class, new SafeEnumAdapter_RENAMED<>(TravelMode.UNKNOWN))
            .registerTypeAdapter(LocationType.class, new SafeEnumAdapter_RENAMED<>(LocationType.UNKNOWN))
            .registerTypeAdapter(RatingType.class, new SafeEnumAdapter_RENAMED<>(RatingType.UNKNOWN))
