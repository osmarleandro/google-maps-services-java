...
@Test
  public void testPlaceDetailsLookupPermanentlyClosedPlace(PlacesApiTest placesApiTest) throws Exception {
    try (LocalTestServerContext sc =
        new LocalTestServerContext(placesApiTest.placeDetailResponseBodyForPermanentlyClosedPlace)) {
      PlaceDetails placeDetails =
          PlacesApi.placeDetails(sc.context, PlacesApiTest.PERMANENTLY_CLOSED_PLACE_ID).await();
