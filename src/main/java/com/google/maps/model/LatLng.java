...
@Test
  public void testTextSearchNYC(PlacesApiTest placesApiTest) throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(placesApiTest.textSearchPizzaInNYCbody)) {
