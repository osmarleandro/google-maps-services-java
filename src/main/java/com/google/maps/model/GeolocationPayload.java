...
public class GeolocationPayload implements Serializable {
  ...
  public static class GeolocationPayloadBuilder {
	...
	public GeolocationApiRequest HomeMobileNetworkCode(GeolocationApiRequest geolocationApiRequest, int newHomeMobileNetworkCode) {
	    HomeMobileNetworkCode(newHomeMobileNetworkCode);
