...
public class GeolocationPayload implements Serializable {
  ...
  public static class GeolocationPayloadBuilder {
	...
	public GeolocationApiRequest HomeMobileCountryCode(GeolocationApiRequest geolocationApiRequest, int newHomeMobileCountryCode) {
	    HomeMobileCountryCode(newHomeMobileCountryCode);
