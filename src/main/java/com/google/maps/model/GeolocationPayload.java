...
public class GeolocationPayload implements Serializable {
  ...
  public static class GeolocationPayloadBuilder {
	...
	public GeolocationApiRequest WifiAccessPoints(GeolocationApiRequest geolocationApiRequest, WifiAccessPoint[] newWifiAccessPoints) {
	    WifiAccessPoints(newWifiAccessPoints);
