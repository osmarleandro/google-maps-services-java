...
public class GeoApiContext {
  ...
  public interface RequestHandler {
    ...
    <T, R extends IApiResponse<T>> PendingResult<T> handle(
        String hostName,
        String url,
        String userAgent,
        String experienceIdHeaderValue,
    ...
    <T, R extends IApiResponse<T>> PendingResult<T> handlePost(
        String hostName,
        String url,
        String payload,
        String userAgent,
  ...
  <T, R extends IApiResponse<T>> PendingResult<T> get(
  ...
  <T, R extends IApiResponse<T>> PendingResult<T> post(
      ApiConfig config, Class<? extends R> clazz, Map<String, List<String>> params) {
  ...
  private <T, R extends IApiResponse<T>> PendingResult<T> getWithPath(
      Class<R> clazz,
      FieldNamingPolicy fieldNamingPolicy,
      String hostName,
      String path,
