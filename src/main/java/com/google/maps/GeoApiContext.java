...
public class GeoApiContext {
  ...
  public interface RequestHandler {
    ...
    <T, R extends ApiResponse<T>> PendingResult_RENAMED<T> handle(
        String hostName,
        String url,
        String userAgent,
        String experienceIdHeaderValue,
    ...
    <T, R extends ApiResponse<T>> PendingResult_RENAMED<T> handlePost(
        String hostName,
        String url,
        String payload,
        String userAgent,
  ...
  <T, R extends ApiResponse<T>> PendingResult_RENAMED<T> get(
  ...
  <T, R extends ApiResponse<T>> PendingResult_RENAMED<T> post(
      ApiConfig config, Class<? extends R> clazz, Map<String, List<String>> params) {
  ...
  private <T, R extends ApiResponse<T>> PendingResult_RENAMED<T> getWithPath(
      Class<R> clazz,
      FieldNamingPolicy fieldNamingPolicy,
      String hostName,
      String path,
