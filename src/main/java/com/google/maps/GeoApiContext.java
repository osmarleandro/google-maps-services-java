...
public class GeoApiContext {
  ...
  public static class Builder {
	...
	@Test
	  public void testQueryParamsHaveOrderPreserved(GeoApiContextTest geoApiContextTest) throws Exception {
	    ...
	    geoApiContextTest.server.enqueue(response);
	    geoApiContextTest.server.start();
	
	    geoApiContextTest.setMockBaseUrl();
	    build()
	        .get(new ApiConfig("/"), Response.class, "a", "1", "a", "2", "a", "3")
	        .awaitIgnoreError();
