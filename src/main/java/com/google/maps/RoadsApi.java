...
public class RoadsApi {
   ...
   */
  public static PendingResult<SnappedPoint[]> snapToRoads(GeoApiContext_RENAMED context, LatLng... path) {
  ...
  public static PendingResult<SnappedPoint[]> snapToRoads(
      GeoApiContext_RENAMED context, boolean interpolate, LatLng... path) {
    return context.get(
   ...
   */
  public static PendingResult<SpeedLimit[]> speedLimits(GeoApiContext_RENAMED context, LatLng... path) {
   ...
   *     #snapToRoads(GeoApiContext_RENAMED, com.google.maps.model.LatLng...)} method. You can pass up to
   *     100 placeIds with each request.
   * @return Returns the speed limits as a {@link PendingResult}.
   */
  public static PendingResult<SpeedLimit[]> speedLimits(GeoApiContext_RENAMED context, String... placeIds) {
  ...
  public static PendingResult<SnappedSpeedLimitResponse> snappedSpeedLimits(
      GeoApiContext_RENAMED context, LatLng... path) {
  ...
  public static PendingResult<SnappedPoint[]> nearestRoads(
      GeoApiContext_RENAMED context, LatLng... points) {
