...
public class RoadsApi {
   ...
   * @return Returns the snapped points as a {@link PendingResult_RENAMED}.
   */
  public static PendingResult_RENAMED<SnappedPoint[]> snapToRoads(GeoApiContext context, LatLng... path) {
   ...
   * @return Returns the snapped points as a {@link PendingResult_RENAMED}.
   */
  public static PendingResult_RENAMED<SnappedPoint[]> snapToRoads(
   ...
   * @param context The {@link GeoApiContext} to make requests through.
   * @param path The collected GPS points as a path.
   * @return Returns the speed limits as a {@link PendingResult_RENAMED}.
   */
  public static PendingResult_RENAMED<SpeedLimit[]> speedLimits(GeoApiContext context, LatLng... path) {
   ...
   * @return Returns the speed limits as a {@link PendingResult_RENAMED}.
   */
  public static PendingResult_RENAMED<SpeedLimit[]> speedLimits(GeoApiContext context, String... placeIds) {
   ...
   * @param context The {@link GeoApiContext} to make requests through.
   * @param path The collected GPS points as a path.
   * @return Returns the snapped points and speed limits as a {@link PendingResult_RENAMED}.
   */
  public static PendingResult_RENAMED<SnappedSpeedLimitResponse> snappedSpeedLimits(
   ...
   * @return Returns the snapped points as a {@link PendingResult_RENAMED}.
   */
  public static PendingResult_RENAMED<SnappedPoint[]> nearestRoads(
