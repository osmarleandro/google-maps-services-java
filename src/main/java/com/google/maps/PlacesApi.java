...
public class PlacesApi {
   ...
   */
  public static IQueryAutocompleteRequest queryAutocomplete(GeoApiContext context, String input) {
    IQueryAutocompleteRequest request = new QueryAutocompleteRequest(context);
    request.input(input);
    return request;
  }
