...
public class TimeZoneApi {
   ...
   * @return Returns the time zone as a {@link PendingResult_RENAMED}.
   */
  public static PendingResult_RENAMED<TimeZone> getTimeZone(GeoApiContext context, LatLng location) {
    return context.get(
        API_CONFIG,
        Response.class,
        "location",
