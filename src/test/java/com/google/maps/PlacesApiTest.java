...
public class PlacesApiTest {
  ...
  public void testPlaceDetailsLookupGoogleSydney() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(placeDetailResponseBody)) {
      ...
      assertEquals(placeDetails.addressComponents[1].types[0], AddressComponentType_RENAMED.STREET_NUMBER);
      ...
      assertEquals(placeDetails.addressComponents[2].types[0], AddressComponentType_RENAMED.ROUTE);
      assertEquals(placeDetails.addressComponents[3].shortName, "Pyrmont");
      assertEquals(placeDetails.addressComponents[3].types[0], AddressComponentType_RENAMED.LOCALITY);
      assertEquals(placeDetails.addressComponents[3].types[1], AddressComponentType_RENAMED.POLITICAL);
      ...
      assertEquals(
          ...
          AddressComponentType_RENAMED.ADMINISTRATIVE_AREA_LEVEL_1);
      assertEquals(placeDetails.addressComponents[4].types[1], AddressComponentType_RENAMED.POLITICAL);
      ...
      assertEquals(placeDetails.addressComponents[5].types[0], AddressComponentType_RENAMED.COUNTRY);
      assertEquals(placeDetails.addressComponents[5].types[1], AddressComponentType_RENAMED.POLITICAL);
      assertEquals(placeDetails.addressComponents[6].shortName, "2009");
      assertEquals(placeDetails.addressComponents[6].types[0], AddressComponentType_RENAMED.POSTAL_CODE);
