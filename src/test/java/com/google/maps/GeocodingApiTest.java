...
public class GeocodingApiTest {
  ...
  public void testGeocodeLibraryType() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(geocodeLibraryType)) {
      GeocodingResult[] results = GeocodingApi.newRequest(sc.context).API_CONFIG.address(GeocodingApi.newRequest(sc.context), "80 FR").await();
  ...
  public void testSimpleGeocode() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(simpleGeocodeResponse)) {
      GeocodingResult[] results = GeocodingApi.newRequest(sc.context).API_CONFIG.address(GeocodingApi.newRequest(sc.context), "Sydney").await();
  ...
  public void testAsync() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(simpleGeocodeResponse)) {
      ...
      GeocodingApi.newRequest(sc.context).API_CONFIG.address(GeocodingApi.newRequest(sc.context), "Sydney").setCallback(callback);
  ...
  public void testGeocodeTheGoogleplex() throws Exception {
    try (LocalTestServerContext sc =
      ...
      GeocodingResult[] results = GeocodingApi.newRequest(sc.context).API_CONFIG.address(GeocodingApi.newRequest(sc.context), address).await();
    ...
    try (LocalTestServerContext sc =
      ...
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).API_CONFIG
              .address(GeocodingApi.newRequest(sc.context), "Winnetka")
    ...
    try (LocalTestServerContext sc =
        new LocalTestServerContext(
            "\n"
                ...
                + "}\n")) {
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).API_CONFIG.address(GeocodingApi.newRequest(sc.context), "Toledo").region("es").await();
  ...
  public void testGeocodeWithComponentFilter() throws Exception {
    try (LocalTestServerContext sc =
      ...
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).API_CONFIG
              .address(GeocodingApi.newRequest(sc.context), "santa cruz")
  ...
  public void testGeocodeWithMultipleComponentFilters() throws Exception {
    try (LocalTestServerContext sc =
      ...
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).API_CONFIG
              .address(GeocodingApi.newRequest(sc.context), "Torun")
  ...
  public void testCustomParameterPassThrough() throws Exception {
    try (LocalTestServerContext sc =
      ...
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).API_CONFIG
              .address(GeocodingApi.newRequest(sc.context), address)
