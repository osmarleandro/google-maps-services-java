...
public class GeocodingApiTest {
  ...
  public void testGeocodeLibraryType() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(geocodeLibraryType)) {
      GeocodingResult[] results = GeocodingApi.newRequest(sc.context).param("address", "80 FR").await();
  ...
  public void testSimpleGeocode() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(simpleGeocodeResponse)) {
      GeocodingResult[] results = GeocodingApi.newRequest(sc.context).param("address", "Sydney").await();
  ...
  public void testAsync() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(simpleGeocodeResponse)) {
      ...
      GeocodingApi.newRequest(sc.context).param("address", "Sydney").setCallback(callback);
  ...
  public void testGeocodeTheGoogleplex() throws Exception {
    try (LocalTestServerContext sc =
      ...
      GeocodingResult[] results = GeocodingApi.newRequest(sc.context).param("address", address).await();
  ...
  public void testGeocodeWithBounds() throws Exception {
    try (LocalTestServerContext sc =
      ...
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).param("address", "Winnetka")
    ...
    try (LocalTestServerContext sc =
        new LocalTestServerContext(
            "\n"
                ...
                + "}\n")) {
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).param("address", "Toledo").region("es").await();
    ...
    try (LocalTestServerContext sc =
        new LocalTestServerContext(
            "\n"
                ...
                + "}\n")) {
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).param("address", "santa cruz")
    ...
    try (LocalTestServerContext sc =
        new LocalTestServerContext(
            "\n"
                ...
                + "}\n")) {
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).param("address", "Torun")
  ...
  public void testCustomParameterPassThrough() throws Exception {
    try (LocalTestServerContext sc =
      ...
      String address = "1600 Amphitheatre Parkway, Mountain View, CA";
      GeocodingResult[] results =
          GeocodingApi.newRequest(sc.context).param("address", address)
