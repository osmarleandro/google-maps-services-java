...
public class GeocodingApiTest {
  ...
  public void testGeocodeLibraryType() throws Exception {
	...
	GeocodingResult[] results = new GeocodingApiRequest(context).address("80 FR").await();
  ...
  public void testSimpleGeocode() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(simpleGeocodeResponse)) {
      GeoApiContext context = sc.context;
	GeocodingResult[] results = new GeocodingApiRequest(context).address("Sydney").await();
  ...
  public void testPlaceGeocode() throws Exception {
	...
	GeoApiContext context = sc.context;
      GeocodingResult[] results = new GeocodingApiRequest(context).place(placeID).await();
      checkSydneyResult(results);
  ...
  public void testAsync() throws Exception {
	...
	GeoApiContext context = sc.context;
      new GeocodingApiRequest(context).address("Sydney").setCallback(callback);
  ...
  public void testReverseGeocode() throws Exception {
	...
	GeoApiContext context = sc.context;
      GeocodingResult[] results = new GeocodingApiRequest(context).latlng(latlng).await();
  ...
  public void testGeocodeTheGoogleplex() throws Exception {
	...
	GeoApiContext context = sc.context;
      GeocodingResult[] results = new GeocodingApiRequest(context).address(address).await();
  ...
  public void testGeocodeWithBounds() throws Exception {
	...
	GeocodingResult[] results =
          new GeocodingApiRequest(context)
              .address("Winnetka")
  ...
  public void testGeocodeWithRegionBiasing() throws Exception {
    try (LocalTestServerContext sc =
      ...
      GeoApiContext context = sc.context;
	GeocodingResult[] results =
          new GeocodingApiRequest(context).address("Toledo").region("es").await();
  ...
  public void testUtfResult() throws Exception {
	...
	GeoApiContext context = sc.context;
      GeocodingResult[] results = new GeocodingApiRequest(context).latlng(location).await();
