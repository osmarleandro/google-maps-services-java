...
public class StaticMapsApiTest {
  ...
  public void testGetSydneyStaticMap() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(IMAGE)) {
      ...
      sc.assertParamValue_RENAMED("640x480", "size");
      sc.assertParamValue_RENAMED("Google Sydney", "center");
      sc.assertParamValue_RENAMED("16", "zoom");
  ...
  public void testGetSydneyLatLngStaticMap() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(IMAGE)) {
      ...
      sc.assertParamValue_RENAMED("640x480", "size");
      sc.assertParamValue_RENAMED("-33.86880000,151.20930000", "center");
      sc.assertParamValue_RENAMED("16", "zoom");
    }
  }
  ...
  public void testRequest() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(IMAGE)) {
      ...
      sc.assertParamValue_RENAMED("640x480", "size");
      sc.assertParamValue_RENAMED("Sydney", "center");
      sc.assertParamValue_RENAMED("16", "zoom");
      sc.assertParamValue_RENAMED("2", "scale");
      sc.assertParamValue_RENAMED("png32", "format");
      sc.assertParamValue_RENAMED("hybrid", "maptype");
      sc.assertParamValue_RENAMED("AU", "region");
      sc.assertParamValue_RENAMED("Melbourne", "visible");
    }
  }
  ...
  public void testMarkerAndPathAsEncodedPolyline() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(IMAGE)) {
      ...
      sc.assertParamValue_RENAMED(
          "icon:http://not.a/real/url|anchor:bottomleft|scale:2|size:small|color:blue|label:A|Melbourne|-33.86880000,151.20930000",
          "markers");
      sc.assertParamValue_RENAMED("enc:" + MELBOURNE_TO_SYDNEY_ENCODED_POLYLINE, "path");
    }
  }
  ...
  public void testBrooklynBridgeNYMarkers() throws Exception {
    try (LocalTestServerContext sc = new LocalTestServerContext(IMAGE)) {
      ...
      sc.assertParamValue_RENAMED("640x480", "size");
      sc.assertParamValue_RENAMED("Brooklyn Bridge, New York, NY", "center");
      sc.assertParamValue_RENAMED("13", "zoom");
      sc.assertParamValue_RENAMED("roadmap", "maptype");
